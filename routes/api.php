...
Route::group(
    ...
    function () {
        ...
        // Phonebook API Routes (outside checkApiKey middleware for now)
        Route::post('/api-fetch-groups', [PhonebookController::class, 'fetchGroups']);
        Route::get('/api-phonebook', [PhonebookController::class, 'getPhonebook']);
        Route::post('/api-phonebook', [PhonebookController::class, 'getPhonebook']);
        Route::post('/api-clear-phonebook', [PhonebookController::class, 'clearPhonebook']);
        Route::get('/api-group-contacts', [PhonebookController::class, 'getGroupContacts']);
        Route::post('/api-group-contacts', [PhonebookController::class, 'getGroupContacts']);
