<div class="tab-pane" id="createuser" role="tabpanel">
    <div class="bg-white rounded-xl shadow-lg border border-gray-200">
        ...
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center">
                ...
                <div>
                    <h2 class="text-xl font-semibold text-gray-900">Create User API</h2>
        ...
        <div class="p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <code
                        class="bg-gray-100 text-gray-800 px-3 py-1 rounded text-sm">{{ env('APP_URL') }}/create-user</code>
                </div>
            </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 text-sm text-gray-500">Username (must not contain symbols)</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 text-sm text-gray-500">User email address</td>
                            </tr>
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">expire</td>
                                ...
                                <td class="px-6 py-4 text-sm text-gray-500">Subscription expiry time in days (e.g., 30)
                                </td>
                            </tr>
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">limit_device
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">number</td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span
                                ...
                                <td class="px-6 py-4 text-sm text-gray-500">Maximum number of devices allowed (e.g., 10)
                                </td>
                            </tr>
                        </tbody>
                    </table>
  ...
  "limit_device": 10
                ...
                <div>
                    ...
                    <div class="bg-gray-900 rounded-lg p-4 overflow-x-auto">
                        <pre class="text-blue-400 text-sm"><code>{{ env('APP_URL') }}/create-user?api_key=1234567890&username=newuser&password=12345678&email=user@example.com&expire=30&limit_device=10</code></pre>
                    </div>
                </div>
            </div>
