<div class="tab-pane" id="sendmedia" role="tabpanel">
    <div class="bg-white rounded-xl shadow-lg border border-gray-200">
        ...
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center">
                ...
                <div>
                    <h2 class="text-xl font-semibold text-gray-900">Send Media API</h2>
                    <p class="text-sm text-gray-600">Send media files (images, videos, audio, documents) to WhatsApp</p>
                </div>
            </div>
        </div>
        ...
        <div class="p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <code
                        class="bg-gray-100 text-gray-800 px-3 py-1 rounded text-sm">{{ env('APP_URL') }}/send-media</code>
                </div>
            </div>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">media_type
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">string</td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span
                                ...
                                <td class="px-6 py-4 text-sm text-gray-500">Media type: image, video, audio, document
                                </td>
                            </tr>
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">caption</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">string</td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span
                                ...
                                <td class="px-6 py-4 text-sm text-gray-500">Optional caption/message for the media</td>
                            </tr>
                            <tr>
                                ...
                                <td class="px-6 py-4 text-sm text-gray-500">Direct URL to the media file</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div class="bg-amber-50 border-l-4 border-amber-400 rounded-lg p-4">
                <div class="flex items-start">
                    <i class="bi bi-exclamation-triangle-fill text-amber-600 mr-2 mt-0.5"></i>
                    <div>
                        <h4 class="text-sm font-medium text-amber-800">Important Note</h4>
                        <p class="text-sm text-amber-700 mt-1">
                            Make sure the URL is a direct link to the media file, not a link from Google Drive or other
  ...
  "url": "https://example.com/image.jpg"
                ...
                <div>
                    ...
                    <div class="bg-gray-900 rounded-lg p-4 overflow-x-auto">
                        <pre class="text-blue-400 text-sm"><code>{{ env('APP_URL') }}/send-media?api_key=1234567890&sender=62888xxxx&number=62888xxxx&media_type=image&caption=Hello World&url=https://example.com/image.jpg</code></pre>
                    </div>
                </div>
            </div>
