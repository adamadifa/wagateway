<div class="tab-pane" id="sendsticker" role="tabpanel">
    <div class="bg-white rounded-xl shadow-lg border border-gray-200">
        <!-- Header -->
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center">
                <div class="w-10 h-10 bg-pink-100 rounded-lg flex items-center justify-center mr-4">
                    <i class="bi bi-emoji-smile text-pink-600 text-lg"></i>
                </div>
                <div>
                    <h2 class="text-xl font-semibold text-gray-900">Send Sticker API</h2>
                    <p class="text-sm text-gray-600">Send sticker messages to WhatsApp numbers</p>
                </div>
            </div>
        </div>
        ...
        <div class="p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <code
                        class="bg-gray-100 text-gray-800 px-3 py-1 rounded text-sm">{{ env('APP_URL') }}/send-sticker</code>
                </div>
            </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 text-sm text-gray-500">Direct URL to the sticker image</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                ...
                <div class="flex items-start">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-amber-700 mt-1">
                            Make sure the URL is a direct link to the sticker image, not a link from Google Drive or
  ...
  "url": "https://example.com/sticker.jpg"
                ...
                <div>
                    ...
                    <div class="bg-gray-900 rounded-lg p-4 overflow-x-auto">
                        <pre class="text-blue-400 text-sm"><code>{{ env('APP_URL') }}/send-sticker?api_key=1234567890&sender=62888xxxx&number=62888xxxx&url=https://example.com/sticker.jpg</code></pre>
                    </div>
                </div>
            </div>
