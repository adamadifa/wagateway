<div class="tab-pane" id="disconnectdevice" role="tabpanel">
    <div class="bg-white rounded-xl shadow-lg border border-gray-200">
        ...
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center">
                ...
                <div>
                    <h2 class="text-xl font-semibold text-gray-900">Disconnect Device API</h2>
                    <p class="text-sm text-gray-600">Disconnect/logout a WhatsApp device</p>
                </div>
            </div>
        </div>
        ...
        <div class="p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <code
                        class="bg-gray-100 text-gray-800 px-3 py-1 rounded text-sm">{{ env('APP_URL') }}/logout-device</code>
                </div>
            </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 text-sm text-gray-500">Device number you want to disconnect</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
  ...
  "sender": "6282298859671"
                ...
                <div>
                    ...
                    <div class="bg-gray-900 rounded-lg p-4 overflow-x-auto">
                        <pre class="text-blue-400 text-sm"><code>{{ env('APP_URL') }}/logout-device?api_key=ndUJR38JkvyCfLZ&sender=6282298859671</code></pre>
                    </div>
                </div>
            </div>
