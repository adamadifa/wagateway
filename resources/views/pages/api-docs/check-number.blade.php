<div class="tab-pane" id="checknumber" role="tabpanel">
    <div class="bg-white rounded-xl shadow-lg border border-gray-200">
        <!-- Header -->
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center">
                <div class="w-10 h-10 bg-amber-100 rounded-lg flex items-center justify-center mr-4">
                    <i class="bi bi-telephone text-amber-600 text-lg"></i>
                </div>
                <div>
                    <h2 class="text-xl font-semibold text-gray-900">Check Number API</h2>
                    <p class="text-sm text-gray-600">Check if a WhatsApp number exists and is valid</p>
                </div>
            </div>
        </div>
        ...
        <div class="p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <code
                        class="bg-gray-100 text-gray-800 px-3 py-1 rounded text-sm">{{ env('APP_URL') }}/check-number</code>
                </div>
            </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 text-sm text-gray-500">Your WhatsApp device number (e.g.,
                                    62888xxxx)</td>
                            </tr>
                            <tr>
                                ...
                                <td class="px-6 py-4 text-sm text-gray-500">Number to check (e.g., 62888xxxx)</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
  ...
  "number": "6281222xxxxx"
                ...
                <div>
                    ...
                    <div class="bg-gray-900 rounded-lg p-4 overflow-x-auto">
                        <pre class="text-blue-400 text-sm"><code>{{ env('APP_URL') }}/check-number?api_key=1234567890&sender=6281222xxxxx&number=6281222xxxxx</code></pre>
                    </div>
                </div>
            </div>
